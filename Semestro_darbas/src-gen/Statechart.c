...
static void enseq_main_region_ReadI2S_default(Statechart* handle);
...
static void exseq_main_region_ReadI2S(Statechart* handle);
...
/*! The reactions of state ReadI2S. */
static sc_integer main_region_ReadI2S_react(Statechart* handle, const sc_integer transitioned_before);
	...
	switch (state)
	{
		case Statechart_main_region_WaitSamplePeriod :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STATECHART_MAIN_REGION_WAITSAMPLEPERIOD] == Statechart_main_region_WaitSamplePeriod
				...
				break;
		case Statechart_main_region_ReadI2S :
			result = (sc_boolean) (handle->stateConfVector[SCVI_STATECHART_MAIN_REGION_READI2S] == Statechart_main_region_ReadI2S
			);
				break;
...
static void micro_step(Statechart* handle)
{
	switch(handle->stateConfVector[ 0 ])
	{
		...
		case Statechart_main_region_ReadI2S :
		{
			main_region_ReadI2S_react(handle,-1);
			break;
		}
		case Statechart_main_region_DisplayData :
		{
...
static void enact_main_region_ReadI2S(Statechart* handle)
{
	/* Entry action for state 'ReadI2S'. */
	statechart_readI2SSensor(handle);
	statechart_saveI2SSample(handle,handle->internal.sample_no);
...
static void enact_main_region_UART(Statechart* handle)
{
	...
	statechart_uartData(handle);
	handle->completed = bool_true;
}

/* Exit action for state 'ReadI2S'. */
static void exact_main_region_ReadI2S(Statechart* handle)
{
	/* Exit action for state 'ReadI2S'. */
...
/* 'default' enter sequence for state ReadI2S */
static void enseq_main_region_ReadI2S_default(Statechart* handle)
{
	/* 'default' enter sequence for state ReadI2S */
	enact_main_region_ReadI2S(handle);
	handle->stateConfVector[0] = Statechart_main_region_ReadI2S;
}
...
/* Default exit sequence for state ReadI2S */
static void exseq_main_region_ReadI2S(Statechart* handle)
{
	/* Default exit sequence for state ReadI2S */
	handle->stateConfVector[0] = Statechart_last_state;
	exact_main_region_ReadI2S(handle);
}
...
static void exseq_main_region(Statechart* handle)
{
	...
	switch(handle->stateConfVector[ 0 ])
	{
		...
		case Statechart_main_region_ReadI2S :
		{
			exseq_main_region_ReadI2S(handle);
			break;
		}
		case Statechart_main_region_DisplayData :
		{
...
static sc_integer main_region_WaitSamplePeriod_react(Statechart* handle, const sc_integer transitioned_before)
{
	...
	{ 
		...
		{ 
			...
			{ 
				exseq_main_region_WaitSamplePeriod(handle);
				enseq_main_region_ReadI2S_default(handle);
...
static sc_integer main_region_ReadI2S_react(Statechart* handle, const sc_integer transitioned_before)
{
	...
	{ 
		...
		if (((handle->internal.sample_no % 25)) == (0))
		{ 
...
static sc_integer main_region_UART_react(Statechart* handle, const sc_integer transitioned_before)
{
	...
	{ 
		...
		handle->stateConfVector[0] = Statechart_last_state;
		/* The reactions of state null. */
		if ((handle->internal.sample_no) == (100))
		{ 
