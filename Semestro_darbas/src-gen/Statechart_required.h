...
- statechart_readI2SSensor
- statechart_saveI2SSample
- statechart_uartData
...
*/
extern void statechart_readI2SSensor( Statechart* handle);
extern sc_integer statechart_saveI2SSample( Statechart* handle, const sc_integer sample_no);
extern void statechart_uartData( Statechart* handle);
